using Hooshabi.Server.Application.Identity.Roles;
...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(HooshabiAction.View, HooshabiResource.Roles)]
    ...
    [MustHavePermission(HooshabiAction.View, HooshabiResource.RoleClaims)]
    ...
    [MustHavePermission(HooshabiAction.Update, HooshabiResource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(HooshabiAction.Create, HooshabiResource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(HooshabiAction.Delete, HooshabiResource.Roles)]
