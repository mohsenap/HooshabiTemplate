    ...
    return (
      <Fragment>
        <BaseComponent
          ...
          action={`/api/${AppManager.GetAPIVersion()}/entity/search`}
          method="POST"
          newItem={true}
        ...
        >
          <BaseComponent
            ...
            action={`/api/${AppManager.GetAPIVersion()}/Entity/${
              this.state.FormKey
            }`}
            get={`/api/${AppManager.GetAPIVersion()}/Entity/${
              this.state.FormKey
            }`}
            post={`/api/${AppManager.GetAPIVersion()}/Entity`}
            put={`/api/${AppManager.GetAPIVersion()}/Entity/${
              this.state.FormKey
            }`}
            delte={`/api/${AppManager.GetAPIVersion()}/Entity/${
              this.state.FormKey
            }`}
